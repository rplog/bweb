...
var onRequest = /* @__PURE__ */ __name(async (context) => {
  ...
  return new Response(JSON.stringify({
    ...
    // Simulated TTL variation
  }), {
    headers: { "Content-Type": "application/json" }
  });
}, "onRequest");

// ../.wrangler/tmp/pages-skD3nI/functionsRoutes-0.13654407188905104.mjs
var routes = [
  {
    routePath: "/api/ping",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-a5DQcY/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-a5DQcY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3898111830751406.mjs.map
